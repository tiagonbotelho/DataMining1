...
The following map is from the houston police department. As we can see, each police beat is linked to a specific area of the city
...
ggplot(offenses_by_weekday, aes(x=WeekDay, y=Offenses)) + geom_bar()
```
...
#correlation between the predictions and the true values = 0.31
cr <- cor(ps, ts$Offenses)
#mean average percentage error = 0.50
